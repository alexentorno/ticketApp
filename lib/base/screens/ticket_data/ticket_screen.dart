...
import 'package:flutter_demo/base/screens/ticket_data/widgets/sticky_circle.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const StickyCircle(isPositionRight: false,),
          const StickyCircle(isPositionRight: true)
        ],
      ),
    );
  }
